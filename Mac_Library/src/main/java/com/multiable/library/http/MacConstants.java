...
public class MacConstants {
    ...
    public static final String BPM_CONFIG_FILE_PATH = "com/ibm/oauth/Oauth2ClientBPM.config";
    public static final String CONFIG_FILE_PATH = "com/ibm/oauth/Oauth2ClientGoogle.config";
